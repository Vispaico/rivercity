...
import { i as init_browser, n as browser_default, r as browser_exports, t as Headers$1 } from "./browser-CISXwscl.js";
...
var resolveFetch$3 = (customFetch) => {
	...
	else if (typeof fetch === "undefined") _fetch = (...args) => import("./browser-CISXwscl.js").then((n) => (n.i(), n.r)).then(({ default: fetch }) => fetch(...args));
	else _fetch = fetch;
	...
	var PostgrestBuilder = class {
		...
		*/
		...
		then(onfulfilled, onrejected) {
			if (this.schema === void 0) {} else if (["GET", "HEAD"].includes(this.method)) this.headers["Accept-Profile"] = this.schema;
			...
			let res = _fetch(this.url.toString(), {
				...
				if (res.ok) {
					if (this.method !== "HEAD") {
						...
						if (body === "") {} else if (this.headers["Accept"] === "text/csv") data = body;
...
//#endregion
//#region node_modules/@supabase/postgrest-js/dist/cjs/version.js
...
//#endregion
//#region node_modules/@supabase/postgrest-js/dist/cjs/constants.js
...
var version$3 = "2.11.2";
//#endregion
//#region node_modules/@supabase/realtime-js/dist/module/lib/constants.js
var DEFAULT_HEADERS$3 = { "X-Client-Info": `realtime-js/${version$3}` };
var VSN = "1.0.0";
...
var RealtimeClient = class {
	...
	*/
	connect() {
		...
		this.conn = new WSWebSocketDummy(this.endpointURL(), void 0, { close: () => {
			this.conn = null;
		} });
		import("./browser-DsRt1v6x.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ default: WS }) => {
	...
	async setAuth(token = null) {
		...
		if (tokenToSend) {
			...
			if (parsed && parsed.exp) {
				if (!(Math.floor(Date.now() / 1e3) - parsed.exp < 0)) {
	...
	*/
	async sendHeartbeat() {
		...
		if (this.pendingHeartbeatRef) {
			...
			(_a = this.conn) === null || _a === void 0 || _a.close(1e3, "hearbeat timeout");
			return;
		}
...
var resolveResponse = () => __awaiter$6(void 0, void 0, void 0, function* () {
	if (typeof Response === "undefined") return (yield import("./browser-CISXwscl.js").then((n) => (n.i(), n.r))).Response;
	return Response;
});
		...
		return __awaiter$4(this, void 0, void 0, function* () {
			try {
				...
				const res = yield this.fetch(`${this.url}/object/${_path}`, Object.assign({
					...
					body,
					headers
				}, (options === null || options === void 0 ? void 0 : options.duplex) ? { duplex: options.duplex } : {}));
...
var GoTrueClient = class GoTrueClient {
	...
	*/
	constructor(options) {
		...
		*/
		...
		if (this.persistSession) if (settings.storage) this.storage = settings.storage;
		else if (supportsLocalStorage()) this.storage = localStorageAdapter;
		else {
			this.memoryStorage = {};
	...
	*/
	...
	async fetchJwk(kid, jwks = { keys: [] }) {
		...
		if (jwk && this.jwks_cached_at + 6e5 > Date.now()) return jwk;
		const { data, error } = await _request(this.fetch, "GET", `${this.url}/.well-known/jwks.json`, { headers: this.headers });
		if (error) throw error;
		if (!data.keys || data.keys.length === 0) throw new AuthInvalidJwtError("JWKS is empty");
		this.jwks = data;
		this.jwks_cached_at = Date.now();
		jwk = data.keys.find((key) => key.kid === kid);
		if (!jwk) throw new AuthInvalidJwtError("No matching signing key found in JWKS");
		return jwk;
	}
	/**
