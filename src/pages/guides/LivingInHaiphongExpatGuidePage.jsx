              ...
              <div className="overflow-hidden rounded-3xl border bg-white shadow-lg">
                <div className="relative h-56 sm:h-64">
                  <img
                    ...
                    decoding="async"
                  />
                  <div className="absolute inset-1 bg-gradient-to-r from-black/70 via-black/35 to-transparent" />
                  <div className="absolute inset-2 p-6 sm:p-10 flex flex-col justify-end">
